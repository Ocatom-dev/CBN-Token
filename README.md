...
contract create is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'create';
    ...
    uint256 private _tTotal = 1500000 * _DECIMALFACTOR;
    ...
    function _getTotalBurned() public view returns(uint256)  {
        return _tBurnTotal;
    }
